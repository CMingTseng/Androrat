...
public class GUI extends javax.swing.JFrame {
    ...
    // *******************************
    //	Mthodes de modif du tableau
    // *******************************

    /**
     * Ajoute une ligne "client" dans le tableau des clients connectés
     * @param imei L'identifiant t phone
     * @param countryCode Le code du pays o  se trouve l'appareil
     * @param telNumber Le numero de t phone (si disponible) de l'appareil
    ...
    /**
     * Enlve de la table des clients, le client mis en paramtre
    ...
    /**
     * Mthode appele par les UserGUI lors de leur fermeture afin de supprimer la rfrence dans la HashMap
    ...
    /**
     * Fonction gnrant les lments SWING de l'interface graphique
     * NE PAS TOUCHER !!
     */
